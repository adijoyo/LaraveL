...
@section('container')
 ...
 <div class="card mb-3">
   ...
   <div class="card-body text-center">
     ...
     <h5>By. <a href="/posts?author={{ $posts[0]->author->username }}"" class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}</a> Category</h5>
     </small>

     <p class="card-text">
      <small class="text-muted">Last updated {{ $posts[0]->created_at->diffForHumans() }}</small></p>
   </p>
 ...
 <div class="container">
   <div class="row">
      ...
      <div class="col-md-4 mb-3">
         <div class="card">
            <div class="position-absolute px-3 py-2 " style="background-color: rgba(255, 255, 255, 0.7)"><a href="/posts?category={{ $post->category->slug }}" class="text-dark text-decoration-none">{{ $post->category->name }}</a></div>
